...
while_statement_syntax::while_statement_syntax(expression_syntax* condition, statement_syntax* body) :
...
branch_statement_syntax::branch_statement_syntax(branch_type type) : type(type), statement_syntax()
{
}
...
return_statement_syntax::return_statement_syntax() : expression(nullptr), statement_syntax()
{
}

return_statement_syntax::return_statement_syntax(expression_syntax* expression) : expression(expression), statement_syntax()
{
...
expression_statement_syntax::expression_statement_syntax(expression_syntax* expression) : expression(expression), statement_syntax()
{
	expression->set_parent(this);
}
...
assignment_statement_syntax::assignment_statement_syntax(string identifier, expression_syntax* value) :
...
block_statement_syntax::block_statement_syntax(list_syntax<statement_syntax>* statement_list) : statement_list(statement_list), statement_syntax()
{
